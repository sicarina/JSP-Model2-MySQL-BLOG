		...
		<div class="container">
			<div class="row blog-entries element-animate">
				...
				<div class="col-md-12 col-lg-8 main-content">
					...
					<div class="row mb-5">
						<div class="col-md-12">
							<form action="/blogNew/board?cmd=update" method="post" id="updateForm">
								<div class="row">
								...
								<div class="row">
									<div class="col-md-12 form-group">
										<textarea name="content" id="summernote" class="form-control " cols="30" rows="8">${board.content}</textarea>
									</div>
								</div>
								<br/>
								<div class="row">
